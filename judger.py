...
class Judger:
    ...
    def norm_math_str(self, string: str):
        ...
        # Convert ^[...] and ^(...) to ^{...} so parse_latex can handle bracket/paren exponents
    ...
    def judge_expression(self, pred, gold, **kwargs):
        ...
        expr1_sym = trigsimp(self.sympy_sub_pi(safe_parse(exp1)))
        expr2_sym = trigsimp(self.sympy_sub_pi(safe_parse(exp2)))
